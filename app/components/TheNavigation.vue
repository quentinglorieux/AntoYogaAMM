  ...
  <nav class="bg-white/90 backdrop-blur-md shadow-sm sticky top-0 z-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16">
        ...
        <div class="md:hidden flex items-center z-50 relative">
          <button @click="isOpen = !isOpen" class="text-gray-600 hover:text-gray-900 focus:outline-none p-2 rounded-md hover:bg-gray-100 transition-colors">
    ...
    >
      <div v-if="isOpen" class="fixed inset-0 z-40 bg-white md:hidden overflow-y-auto">
        <div class="flex flex-col min-h-screen pt-24 px-6 pb-12 space-y-8">
